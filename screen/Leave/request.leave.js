            ...
            <Container>
                <ScrollView>
                    <View style={[style.container]}>
                        ...
                        {/* reason */}
                        <Textarea rowSpan={5} bordered placeholder="Reason for Leave" style={style.mb20}/>

                        <View style={[style.dispayFlex, style.flexRow, style.justifyBetween, style.itemCente]}>
                            ...
                            <Button primary style={{padding: 20, paddingBottom: 20, paddingTop: 20, backgroundColor: color.primary}}>
                                <Text style={style.textLight}>Add File</Text>
                            </Button>
                        </View>
                ...
                <Footer>
                    <FooterTab style={style.backgroundPrimary}>
                        <Button>
                            <Text style={[style.textLight, style.h3]}>Submit</Text>
                        </Button>
                    </FooterTab>
                </Footer>            
            </Container>
